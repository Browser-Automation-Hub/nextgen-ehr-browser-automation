/**
 * auth.js — Authentication handler for NextGen EHR
 * Supports: SSO (Azure AD / Okta / ADFS), MFA (Duo Security / Email OTP)
 *
...
const BASE_URL = process.env.NEXTGEN_URL || 'https://your-practice.nextgen.com/login';
...
async function performLogin(page) {
  if (!USERNAME || !PASSWORD) {
    throw new Error(`Set NEXTGEN_USERNAME and NEXTGEN_PASSWORD in .env`);
  }

  console.log('Logging in to NextGen EHR...');
  await page.goto(BASE_URL, { waitUntil: 'networkidle2' });
